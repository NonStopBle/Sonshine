...
#undef _CONVERT_2_ARG_
  ...
  video_t video {
    ...
    // nvv4l2 (Jetson) uses default member initializers from the struct definition
  };
  ...
  void apply_config(std::unordered_map<std::string, std::string> &&vars) {
    ...
    int_between_f(vars, "nvv4l2_preset", video.nvv4l2.preset, {1, 4});
    bool_f(vars, "nvv4l2_max_perf", video.nvv4l2.max_perf);
    int_between_f(vars, "nvv4l2_idr_interval", video.nvv4l2.idr_interval, {0, 60});
    bool_f(vars, "nvv4l2_two_pass_cbr", video.nvv4l2.two_pass_cbr);
    bool_f(vars, "nvv4l2_insert_sps_pps", video.nvv4l2.insert_sps_pps);
    int_between_f(vars, "nvv4l2_rc_mode", video.nvv4l2.rc_mode, {0, 1});
#endif
